...
### #14353 - Comprehensive Plan for Three Claude-Mem Issues
**Date**: Nov 23, 2025
**Type**: Decision
...
- User data stored at ~/.claude-mem/ separate from plugin code (safe switching)
...
*Generated by claude-mem using its own memory system. 5 hypotheses, 22 decisions, 10 days - iterating toward a working solution.*
