---
title: "Plugin Hooks"
description: "6 lifecycle hooks that power Rad-Mem"
---

# Plugin Hooks

Rad-Mem integrates with Claude Code through 6 hook scripts across 5 lifecycle events that capture events and inject context. Additionally, a smart-install pre-hook script manages dependencies.
...
- Provides tips for using rad-mem effectively
- Shows link to web viewer UI (http://localhost:38888)
