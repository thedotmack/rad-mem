...
description: "System components and data flow in Rad-Mem"
---
...
Rad-Mem operates as a Claude Code plugin with five core components:
...
### 5. Viewer UI
React + TypeScript web interface at http://localhost:38888 featuring:
