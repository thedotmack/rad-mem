---
title: "Installation"
description: "Install Rad-Mem plugin for persistent memory across sessions"
---
...
Install Rad-Mem directly from the plugin marketplace:
...
- Database: `${CLAUDE_PLUGIN_ROOT}/data/rad-mem.db`
...
- **Data Location Changed**: Database moved from `~/.rad-mem/` to `${CLAUDE_PLUGIN_ROOT}/data/` (inside plugin directory)
...
See [CHANGELOG](https://github.com/thedotmack/rad-mem/blob/main/CHANGELOG.md) for complete details.

## Next Steps

- [Getting Started Guide](usage/getting-started) - Learn how Rad-Mem works automatically
- [MCP Search Tools](usage/search-tools) - Query your project history
- [Configuration](configuration) - Customize Rad-Mem behavior
