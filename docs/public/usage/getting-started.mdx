...
description: "Learn how Rad-Mem works automatically in the background"
---

# Getting Started with Rad-Mem

## Automatic Operation

Rad-Mem works automatically once installed. No manual intervention required!
...
Every time Claude uses a tool, rad-mem captures it:
...
Context is stored in SQLite database at `~/.rad-mem/rad-mem.db`.
...
Rad-Mem supports sessions that span multiple user prompts:
...
Rad-Mem uses the mem-search skill for querying your project history. Simply ask naturally:
